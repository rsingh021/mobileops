...
import { SMTPClient }   from 'https://deno.land/x/denomailer@1.1.3/mod.ts'

const GMAIL_ADDRESS   = Deno.env.get('GMAIL_ADDRESS')!
const GMAIL_APP_PW    = Deno.env.get('GMAIL_APP_PASSWORD')!
const TECH_EMAIL      = Deno.env.get('TECH_EMAIL')!
...
Deno.serve(async () => {
  ...
  // Open one SMTP connection and send all queued emails
